...
QtObject {
    ...
    // Weather (Phosphor codepoints, shared across weights)
    readonly property string wCloud: "\u{e1aa}"
    readonly property string wCloudSun: "\u{e540}"
    readonly property string wCloudMoon: "\u{e53e}"
    readonly property string wCloudFog: "\u{e53c}"
    readonly property string wCloudRain: "\u{e1b4}"
    readonly property string wCloudSnow: "\u{e1b8}"
    readonly property string wCloudLightning: "\u{e1b2}"
    readonly property string wWind: "\u{e5d2}"
    readonly property string wHumidity: "\u{e210}"
    readonly property string wSnowflake: "\u{e5aa}"
    readonly property string wThermometer: "\u{e5cc}"
    readonly property string wUmbrella: "\u{e684}"
    readonly property string wSunHorizon: "\u{e5b6}"
