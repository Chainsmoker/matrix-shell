                ...
                ColumnLayout {
                    ...
                    ColumnLayout {
                        ...
                        TextInputRow {
                            ...
                            value: Config.notch.customText ?? Config.brandName
                    ...
                    ColumnLayout {
                        ...
                        ActionButton {
                            text: "About " + Config.brandName + " " + Config.version
                            icon: Icons.info
                            onClicked: Quickshell.execDetached(["xdg-open", "https://axeni.de/matrix"])
                        }
