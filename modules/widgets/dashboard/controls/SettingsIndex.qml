...
QtObject {
    ...
    // Main Sections:
    // 0: Network, 1: Bluetooth, 2: Mixer, 3: Effects, 4: Theme, 5: Binds, 6: System, 7: Compositor, 8: Matrix
    ...
    readonly property var staticItems: [
        ...
        // Binds > Matrix
        { label: "Launcher Keybind", keywords: "app launcher menu shortcut", section: 5, subSection: "", subLabel: "Binds > Matrix", icon: Icons.rocket, isIcon: true },
        { label: "Dashboard Keybind", keywords: "widgets dashboard shortcut", section: 5, subSection: "", subLabel: "Binds > Matrix", icon: Icons.squaresFour, isIcon: true },
        { label: "Clipboard Keybind", keywords: "copy paste shortcut super v", section: 5, subSection: "", subLabel: "Binds > Matrix", icon: Icons.clipboard, isIcon: true },
        { label: "Emoji Keybind", keywords: "picker shortcut super period", section: 5, subSection: "", subLabel: "Binds > Matrix", icon: Icons.keyboard, isIcon: true },
        { label: "Tmux Keybind", keywords: "terminal shortcut", section: 5, subSection: "", subLabel: "Binds > Matrix", icon: Icons.keyboard, isIcon: true },
        { label: "Wallpapers Keybind", keywords: "background shortcut super comma", section: 5, subSection: "", subLabel: "Binds > Matrix", icon: Icons.keyboard, isIcon: true },
        { label: "Assistant Keybind", keywords: "ai help shortcut", section: 5, subSection: "", subLabel: "Binds > Matrix", icon: Icons.keyboard, isIcon: true },
        { label: "Notes Keybind", keywords: "note shortcut super n", section: 5, subSection: "", subLabel: "Binds > Matrix", icon: Icons.keyboard, isIcon: true },
        { label: "Overview Keybind", keywords: "workspace shortcut super tab", section: 5, subSection: "", subLabel: "Binds > Matrix", icon: Icons.keyboard, isIcon: true },
        { label: "Powermenu Keybind", keywords: "logout shutdown shortcut super escape", section: 5, subSection: "", subLabel: "Binds > Matrix", icon: Icons.power, isIcon: true },
        { label: "Settings Keybind", keywords: "config preferences shortcut", section: 5, subSection: "", subLabel: "Binds > Matrix", icon: Icons.gear, isIcon: true },
        { label: "Lockscreen Keybind", keywords: "lock security shortcut", section: 5, subSection: "", subLabel: "Binds > Matrix", icon: Icons.lock, isIcon: true },
        { label: "Tools Keybind", keywords: "utilities tools shortcut", section: 5, subSection: "", subLabel: "Binds > Matrix", icon: Icons.wrench, isIcon: true },
        { label: "Screenshot Keybind", keywords: "capture screen shortcut print", section: 5, subSection: "", subLabel: "Binds > Matrix", icon: Icons.camera, isIcon: true },
        { label: "Screenrecord Keybind", keywords: "record video shortcut", section: 5, subSection: "", subLabel: "Binds > Matrix", icon: Icons.videoCamera, isIcon: true },
        { label: "Lens Keybind", keywords: "magnifier zoom shortcut", section: 5, subSection: "", subLabel: "Binds > Matrix", icon: Icons.magnifyingGlass, isIcon: true },
        { label: "Reload Keybind", keywords: "refresh restart shortcut", section: 5, subSection: "", subLabel: "Binds > Matrix", icon: Icons.arrowCounterClockwise, isIcon: true },
        { label: "Quit Keybind", keywords: "exit close shortcut", section: 5, subSection: "", subLabel: "Binds > Matrix", icon: Icons.signOut, isIcon: true },
        ...
        { label: "Lock Command", keywords: "matrix lock screen idle", section: 6, subSection: "idle", subLabel: "System > Idle", icon: Icons.moon, isIcon: true },
        ...
        // --- Matrix / Shell ---
        { label: Config.brandName, keywords: "about info credits version shell", section: 8, subSection: "", subLabel: "", icon: Qt.resolvedUrl("../../../../assets/matrix/matrix-icon.svg"), isIcon: false },
        
        // Matrix > Bar
        { label: "Bar", keywords: "panel taskbar top bottom", section: 8, subSection: "bar", subLabel: Config.brandName + " > Bar", icon: Icons.layout, isIcon: true },
        { label: "Bar Position", keywords: "top bottom left right edge", section: 8, subSection: "bar", subLabel: Config.brandName + " > Bar", icon: Icons.layout, isIcon: true },
        { label: "Launcher Icon", keywords: "logo symbol path", section: 8, subSection: "bar", subLabel: Config.brandName + " > Bar", icon: Icons.layout, isIcon: true },
        { label: "Launcher Icon Tint", keywords: "color theme", section: 8, subSection: "bar", subLabel: Config.brandName + " > Bar", icon: Icons.palette, isIcon: true },
        { label: "Launcher Icon Full Tint", keywords: "monochrome color", section: 8, subSection: "bar", subLabel: Config.brandName + " > Bar", icon: Icons.palette, isIcon: true },
        { label: "Launcher Icon Size", keywords: "width height pixels", section: 8, subSection: "bar", subLabel: Config.brandName + " > Bar", icon: Icons.layout, isIcon: true },
        { label: "Pill Style", keywords: "squished roundness radius bar", section: 8, subSection: "bar", subLabel: Config.brandName + " > Bar", icon: Icons.layout, isIcon: true },
        { label: "Firefox Player", keywords: "browser media music", section: 8, subSection: "bar", subLabel: Config.brandName + " > Bar", icon: Icons.layout, isIcon: true },
        { label: "Bar Auto-hide", keywords: "autohide hide show reveal", section: 8, subSection: "bar", subLabel: Config.brandName + " > Bar", icon: Icons.layout, isIcon: true },
        { label: "Pinned on Startup", keywords: "show visible default", section: 8, subSection: "bar", subLabel: Config.brandName + " > Bar", icon: Icons.layout, isIcon: true },
        { label: "Hover to Reveal", keywords: "mouse show hide edge", section: 8, subSection: "bar", subLabel: Config.brandName + " > Bar", icon: Icons.layout, isIcon: true },
        { label: "Hover Region Height", keywords: "pixels trigger area", section: 8, subSection: "bar", subLabel: Config.brandName + " > Bar", icon: Icons.layout, isIcon: true },
        { label: "Show Pin Button", keywords: "toggle pin unpin", section: 8, subSection: "bar", subLabel: Config.brandName + " > Bar", icon: Icons.layout, isIcon: true },
        { label: "Available on Fullscreen", keywords: "overlay game video", section: 8, subSection: "bar", subLabel: Config.brandName + " > Bar", icon: Icons.layout, isIcon: true },
        { label: "Show Running Indicators", keywords: "dots active apps", section: 8, subSection: "bar", subLabel: Config.brandName + " > Bar", icon: Icons.layout, isIcon: true },
        { label: "Show Overview Button", keywords: "workspace switcher", section: 8, subSection: "bar", subLabel: Config.brandName + " > Bar", icon: Icons.layout, isIcon: true },
        { label: "Bar Screens", keywords: "monitor display eDP", section: 8, subSection: "bar", subLabel: Config.brandName + " > Bar", icon: Icons.layout, isIcon: true },
        
        // Matrix > Notch
        { label: "Notch", keywords: "island dynamic island center", section: 8, subSection: "notch", subLabel: Config.brandName + " > Notch", icon: Icons.layout, isIcon: true },
        
        // Matrix > Workspaces
        { label: "Workspaces", keywords: "virtual desktop spaces", section: 8, subSection: "workspaces", subLabel: Config.brandName + " > Workspaces", icon: Icons.squaresFour, isIcon: true },
        { label: "Workspaces Shown", keywords: "number count visible", section: 8, subSection: "workspaces", subLabel: Config.brandName + " > Workspaces", icon: Icons.squaresFour, isIcon: true },
        { label: "Show App Icons", keywords: "application thumbnail workspace", section: 8, subSection: "workspaces", subLabel: Config.brandName + " > Workspaces", icon: Icons.squaresFour, isIcon: true },
        { label: "Always Show Numbers", keywords: "workspace label index", section: 8, subSection: "workspaces", subLabel: Config.brandName + " > Workspaces", icon: Icons.squaresFour, isIcon: true },
        { label: "Show Numbers", keywords: "workspace label index", section: 8, subSection: "workspaces", subLabel: Config.brandName + " > Workspaces", icon: Icons.squaresFour, isIcon: true },
        { label: "Dynamic Workspaces", keywords: "auto add remove flexible", section: 8, subSection: "workspaces", subLabel: Config.brandName + " > Workspaces", icon: Icons.squaresFour, isIcon: true },
        
        // Matrix > Overview
        { label: "Overview", keywords: "expose mission control windows", section: 8, subSection: "overview", subLabel: Config.brandName + " > Overview", icon: Icons.squaresFour, isIcon: true },
        { label: "Overview Rows", keywords: "grid layout vertical", section: 8, subSection: "overview", subLabel: Config.brandName + " > Overview", icon: Icons.squaresFour, isIcon: true },
        { label: "Overview Columns", keywords: "grid layout horizontal", section: 8, subSection: "overview", subLabel: Config.brandName + " > Overview", icon: Icons.squaresFour, isIcon: true },
        { label: "Overview Scale", keywords: "zoom size preview", section: 8, subSection: "overview", subLabel: Config.brandName + " > Overview", icon: Icons.squaresFour, isIcon: true },
        { label: "Overview Workspace Spacing", keywords: "gap margin distance", section: 8, subSection: "overview", subLabel: Config.brandName + " > Overview", icon: Icons.squaresFour, isIcon: true },
        
        // Matrix > Dock
        { label: "Dock", keywords: "taskbar launcher apps favorites", section: 8, subSection: "dock", subLabel: Config.brandName + " > Dock", icon: Icons.layout, isIcon: true },
        { label: "Dock Enabled", keywords: "show hide toggle", section: 8, subSection: "dock", subLabel: Config.brandName + " > Dock", icon: Icons.layout, isIcon: true },
        { label: "Dock Mode", keywords: "default floating integrated style", section: 8, subSection: "dock", subLabel: Config.brandName + " > Dock", icon: Icons.layout, isIcon: true },
        { label: "Dock Position", keywords: "left bottom right edge", section: 8, subSection: "dock", subLabel: Config.brandName + " > Dock", icon: Icons.layout, isIcon: true },
        { label: "Dock Height", keywords: "size thickness pixels", section: 8, subSection: "dock", subLabel: Config.brandName + " > Dock", icon: Icons.layout, isIcon: true },
        { label: "Dock Icon Size", keywords: "width height pixels apps", section: 8, subSection: "dock", subLabel: Config.brandName + " > Dock", icon: Icons.layout, isIcon: true },
        { label: "Dock Spacing", keywords: "gap between icons", section: 8, subSection: "dock", subLabel: Config.brandName + " > Dock", icon: Icons.layout, isIcon: true },
        { label: "Dock Margin", keywords: "edge distance offset", section: 8, subSection: "dock", subLabel: Config.brandName + " > Dock", icon: Icons.layout, isIcon: true },
        { label: "Dock Hover Region Height", keywords: "trigger area pixels", section: 8, subSection: "dock", subLabel: Config.brandName + " > Dock", icon: Icons.layout, isIcon: true },
        { label: "Dock Pinned on Startup", keywords: "show visible default", section: 8, subSection: "dock", subLabel: Config.brandName + " > Dock", icon: Icons.layout, isIcon: true },
        
        // Matrix > Lockscreen
        { label: "Lockscreen", keywords: "lock screen password login", section: 8, subSection: "lockscreen", subLabel: Config.brandName + " > Lockscreen", icon: Icons.lock, isIcon: true },
        
        // Matrix > Desktop
        { label: "Desktop", keywords: "icons wallpaper home", section: 8, subSection: "desktop", subLabel: Config.brandName + " > Desktop", icon: Icons.layout, isIcon: true },
        { label: "Desktop Enabled", keywords: "show hide icons toggle", section: 8, subSection: "desktop", subLabel: Config.brandName + " > Desktop", icon: Icons.layout, isIcon: true },
        { label: "Desktop Icon Size", keywords: "width height pixels", section: 8, subSection: "desktop", subLabel: Config.brandName + " > Desktop", icon: Icons.layout, isIcon: true },
        { label: "Desktop Vertical Spacing", keywords: "gap margin", section: 8, subSection: "desktop", subLabel: Config.brandName + " > Desktop", icon: Icons.layout, isIcon: true },
        { label: "Desktop Text Color", keywords: "label font", section: 8, subSection: "desktop", subLabel: Config.brandName + " > Desktop", icon: Icons.palette, isIcon: true },
        
        // Matrix > System
        { label: "Shell System", keywords: "config settings matrix", section: 8, subSection: "system", subLabel: Config.brandName + " > System", icon: Icons.circuitry, isIcon: true }
    ]
