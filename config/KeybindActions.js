...
var ACTION_CATALOG = [
    { id: "matrix.launcher", label: "Open Launcher", category: "Matrix", dispatcher: "exec", argument: "matrix run launcher", flags: "r" },
    { id: "matrix.dashboard", label: "Open Dashboard", category: "Matrix", dispatcher: "exec", argument: "matrix run dashboard" },
    { id: "matrix.assistant", label: "Open Assistant", category: "Matrix", dispatcher: "exec", argument: "matrix run assistant" },
    { id: "matrix.clipboard", label: "Open Clipboard", category: "Matrix", dispatcher: "exec", argument: "matrix run clipboard" },
    { id: "matrix.emoji", label: "Open Emoji", category: "Matrix", dispatcher: "exec", argument: "matrix run emoji" },
    { id: "matrix.notes", label: "Open Notes", category: "Matrix", dispatcher: "exec", argument: "matrix run notes" },
    { id: "matrix.tmux", label: "Open Tmux", category: "Matrix", dispatcher: "exec", argument: "matrix run tmux" },    { id: "matrix.wallpapers", label: "Open Wallpapers", category: "Matrix", dispatcher: "exec", argument: "matrix run wallpapers" },
    { id: "matrix.config", label: "Open Settings", category: "Matrix", dispatcher: "exec", argument: "matrix run config" },
    { id: "matrix.overview", label: "Open Overview", category: "Matrix", dispatcher: "exec", argument: "matrix run overview" },
    { id: "matrix.powermenu", label: "Open Power Menu", category: "Matrix", dispatcher: "exec", argument: "matrix run powermenu" },
    { id: "matrix.tools", label: "Open Tools", category: "Matrix", dispatcher: "exec", argument: "matrix run tools" },
    { id: "matrix.screenshot", label: "Take Screenshot", category: "Matrix", dispatcher: "exec", argument: "matrix run screenshot" },
    { id: "matrix.screenrecord", label: "Screen Record", category: "Matrix", dispatcher: "exec", argument: "matrix run screenrecord" },
    { id: "matrix.lens", label: "Open Lens", category: "Matrix", dispatcher: "exec", argument: "matrix run lens" },
    { id: "matrix.reload", label: "Reload Matrix", category: "Matrix", dispatcher: "exec", argument: "matrix reload" },
    { id: "matrix.quit", label: "Quit Matrix", category: "Matrix", dispatcher: "exec", argument: "matrix quit" },
    ...
    { id: "brightness.up", label: "Brightness Up", category: "Brightness", dispatcher: "exec", argument: "matrix brightness +5", flags: "le" },
    { id: "brightness.down", label: "Brightness Down", category: "Brightness", dispatcher: "exec", argument: "matrix brightness -5", flags: "le" },
...
function actionFromLegacy(dispatcher, argument, flags) {
    ...
    if (dispatcher === "exec") {
        ...
        if (arg.indexOf("matrix brightness +5") === 0) return { id: "brightness.up", args: {} };
        if (arg.indexOf("matrix brightness -5") === 0) return { id: "brightness.down", args: {} };
